          ...
          <li key={row.id} className="surface-card premium-border rounded-2xl p-4">
            ...
            <div className="mt-3">
              <button
                ...
                onClick={() => remove(row)}
                className="inline-flex min-h-[40px] items-center gap-1.5 rounded-lg border border-[rgb(var(--error)/0.6)] px-4 py-2 text-sm text-[rgb(var(--error))] transition hover:bg-[rgb(var(--error)/0.1)] disabled:opacity-50"
              >
